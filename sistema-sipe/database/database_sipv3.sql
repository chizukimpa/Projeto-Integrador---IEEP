...
CREATE TABLE IF NOT EXISTS `projeto_integrador`.`SOLICITACOES` (
  ...
  `id_secretario_atribuido` INT NULL,
  ...
  INDEX `fk_SOLICITACOES_USUARIOS1_idx` (`USUARIOS_id_usuarios` ASC, `id_secretario_atribuido` ASC) VISIBLE,
  CONSTRAINT `fk_SOLICITACOES_USUARIOS1`
    FOREIGN KEY (`USUARIOS_id_usuarios` , `id_secretario_atribuido`)
    REFERENCES `projeto_integrador`.`USUARIOS` (`id_usuarios` , `id_usuarios`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `projeto_integrador`.`ANEXOS_SOLICITACAO` (
  ...
  INDEX `fk_ANEXOS_SOLICITACAO_SOLICITACOES1_idx` (`SOLICITACOES_id_solicitacao` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `projeto_integrador`.`MOVIMENTACOES` (
  ...
  INDEX `fk_MOVIMENTACOES_SOLICITACOES1_idx` (`SOLICITACOES_id_solicitacao` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `projeto_integrador`.`NOTIFICACOES` (
  ...
  INDEX `fk_NOTIFICACOES_SOLICITACOES1_idx` (`SOLICITACOES_id_solicitacao` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `projeto_integrador`.`ALUNO_TURMA` (
  ...
  INDEX `fk_USUARIOS_has_TURMAS_has_USUARIOS_TURMAS1_idx` (`TURMAS_id_turma` ASC) VISIBLE,
