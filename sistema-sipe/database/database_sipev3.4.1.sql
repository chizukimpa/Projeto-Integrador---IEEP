...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19/05/2026 às 16:47
...
CREATE TABLE `solicitacoes` (
  ...
  `mensagem_aluno` text DEFAULT NULL,
  `arquivo_aluno` varchar(255) DEFAULT NULL,
  `mensagem_secretario` text DEFAULT NULL,
  `arquivo_secretario` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `solicitacoes` (`id_solicitacao`, `numero_protocolo`, `id_tipo`, `justificativa`, `prioridade`, `status`, `data_solicitacao`, `prazo_final`, `data_finalização`, `USUARIOS_id_usuarios`, `id_secretario_atribuido`, `mensagem_aluno`, `arquivo_aluno`, `mensagem_secretario`, `arquivo_secretario`) VALUES
(1, '#2026-2188', 1, 'preciso porque sim', 'COMUM', 'RECEBIDO', '2026-05-12 15:21:30', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL),
(2, '#2026-8306', 2, 'ME MANDA LOGO!', 'URGENTE', 'RECEBIDO', '2026-05-12 15:21:39', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL),
(3, '#2026-5832', 1, 'sim eu quero', 'COMUM', 'RECEBIDO', '2026-05-12 15:23:30', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL),
(4, '#2026-0616', 2, 'QUERO MUITO', 'URGENTE', 'RECEBIDO', '2026-05-12 15:23:39', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL),
(5, '#2026-2504', 1, 'siiik,', 'COMUM', 'FINALIZADO', '2026-05-12 15:28:19', NULL, NULL, 1, 2, NULL, NULL, '', NULL),
(6, '#2026-9451', 1, 'asssa', 'COMUM', 'CANCELADO', '2026-05-12 15:36:37', NULL, NULL, 1, 2, NULL, NULL, '', NULL),
(8, '#2026-8933', 1, 'n ovvaaaa', 'COMUM', 'INDEFERIDO', '2026-05-13 22:53:15', NULL, NULL, 1, 2, NULL, NULL, '', NULL),
(10, '#2026-1630', 1, 'eu quero isso ', 'URGENTE', 'AGUARDANDO_ASSINATURA', '2026-05-14 09:28:28', NULL, NULL, 5, 2, NULL, NULL, '', NULL),
(13, '#2026-9896', 1, 'oloko', 'URGENTE', 'EM-CONFECCAO', '2026-05-14 15:58:34', NULL, NULL, 5, 2, NULL, '6a061b5ac0016_1778785114.jpg', 'lerolero', 'sec_6a061bda6b2cb_1778785242.jpg'),
(14, '#2026-7704', 1, 'lero lero', 'URGENTE', 'DEFERIDO', '2026-05-14 16:06:49', NULL, NULL, 5, 2, NULL, '6a061d49d511f_1778785609.jpg', '', NULL),
(15, '#2026-7267', 1, 'noob', 'URGENTE', 'EM_ANALISE', '2026-05-14 16:13:40', NULL, NULL, 5, 2, NULL, '6a061ee461395_1778786020.jpg', 'estamos analisando veyr', NULL);
...
INSERT INTO `usuarios` (`id_usuarios`, `nome`, `email`, `senha`, `matricula`, `tipo_usuario`, `ativo`, `data_criacao`, `foto_perfil`) VALUES
(1, 'Teste Aluno', 'aluno@teste.com', '202cb962ac59075b964b07152d234b70', 'MAT001', 'ALUNO', 1, '2026-05-12 15:05:29', NULL),
(2, 'Teste Secretario', 'secretario@teste.com', '202cb962ac59075b964b07152d234b70', 'MAT002', 'SECRETARIO', 1, '2026-05-12 15:05:29', NULL),
(3, 'Admin Master', 'adm@teste.com', '202cb962ac59075b964b07152d234b70', 'MAT003', 'ADMINISTRADOR', 1, '2026-05-12 15:05:29', NULL),
(5, 'Enoque Higashi Barros Mitome', 'enoque.mitome@sectet.pa.gov.br', '202cb962ac59075b964b07152d234b70', 'INEP001', 'ALUNO', 1, '2026-05-14 09:26:44', NULL),
(6, 'Novo Secretario', 'novo.secretario@sectet.pa.gov.br', '202cb962ac59075b964b07152d234b70', 'MAT006', 'SECRETARIO', 1, '2026-05-14 10:10:32', NULL);
