...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projeto_integrador`.`CURSOS` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projeto_integrador`.`TURMAS` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projeto_integrador`.`DOCUMENTOS_EMITIDOS` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projeto_integrador`.`CONFIGURACOES_SISTEMA` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projeto_integrador`.`SOLICITACOES` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projeto_integrador`.`ANEXOS_SOLICITACAO` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projeto_integrador`.`MOVIMENTACOES` ;

CREATE TABLE IF NOT EXISTS `projeto_integrador`.`MOVIMENTACOES` (
  `id_movimentacoes` INT NOT NULL AUTO_INCREMENT,
  `id_solicitacao` INT NOT NULL,
  `status` ENUM('RECEBIDO', 'EM_ANALISE', 'EM-CONFECCAO', 'AGUARDANDO_ASSINATURA', 'DEFERIDO', 'INDEFERIDO', 'FINALIZADO') NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projeto_integrador`.`NOTIFICACOES` ;
...
CREATE TABLE IF NOT EXISTS `projeto_integrador`.`NOTIFICACOES` (
  ...
  `mensagem` TEXT NULL,
  `tipo` ENUM('RECEBIDO', 'EM_ANALISE', 'EM-CONFECCAO', 'AGUARDANDO_ASSINATURA', 'DEFERIDO', 'INDEFERIDO', 'FINALIZADO') NULL,
  `lida` TINYINT NULL,
...
-- -----------------------------------------------------
-- Table `projeto_integrador`.`USUARIOS_has_TURMAS_has_USUARIOS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projeto_integrador`.`USUARIOS_has_TURMAS_has_USUARIOS` ;

CREATE TABLE IF NOT EXISTS `projeto_integrador`.`USUARIOS_has_TURMAS_has_USUARIOS` (
  `USUARIOS_has_TURMAS_TURMAS_id_turma` INT NOT NULL,
  `USUARIOS_has_TURMAS_TURMAS_aluno-turma_idaluno-turma` INT NOT NULL,
  `USUARIOS_has_TURMAS_TURMAS_CURSOS_id_cursos` INT NOT NULL,
  `USUARIOS_id_usuarios` INT NOT NULL,
  ...
  CONSTRAINT `fk_USUARIOS_has_TURMAS_has_USUARIOS_TURMAS1`
    FOREIGN KEY (`TURMAS_id_turma` , `TURMAS_aluno-turma_idaluno-turma` , `TURMAS_CURSOS_id_cursos`)
    REFERENCES `projeto_integrador`.`TURMAS` (`id_turma` , `aluno-turma_idaluno-turma` , `CURSOS_id_cursos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projeto_integrador`.`LOGS` ;
